...
def running2():
    ...
    df1 = []
    toko = 'F04S'
    ftoko = ['F04S', 'F0OA', 'F1AM', 'F1FF', 'F2H7', 'F2LV', 'F2NG', 'F3GA', 'F3IE', 'F4IC', 'F4NB', 'F5CP', 'F7GJ', 'F7IG', 'F7NG', 'F7PW', 'F8C8', 'F8WP', 'F9ML''F9R1', 'F9Z5', 'FA2A', 'FA8H', 'FAKU', 'FAS8', 'FBJE', 'FCMG', 'FCYC', 'FDI0', 'FENY', 'FFV2', 'FFZQ', 'FG7H', 'FGL5', 'FGTJ', 
            'FH98', 'FHUG', 'FJ87', 'FKB1', 'FKDI', 'FKMZ', 'FKW4', 'FKWI', 'FLMB', 'FM4R', 'FM54', 'FM7I', 'FMHJ', 'FMMK', 'FMUT', 'FN4K', 'FN71', 'FNNN', 'FNSB', 'FPMA', 'FQCL','FQQU', 'FRG8', 'FRQQ', 'FRY6', 'FSHH', 'FSPK', 'FU4V', 'FUL4', 'FUUU', 'FVDC', 'FWEK', 'FWWB', 'FX4J', 'T0GG', 'T0YB',
            'T0YY', 'T1AD', 'T1E3', 'T1FD', 'T1LY', 'T1M3', 'T1MH', 'T270', 'T2BF', 'T2JS', 'T2JT', 'T2PR', 'T3BJ', 'T3CY', 'T3GI', 'T3GP', 'T3RM', 'T3WN', 'T3YC', 'T44V', 'T4GL', 'T4KL', 'T4MN', 'T4MW', 'T4MX', 'T4PD', 'T4PP', 'T4U1', 'T4ZR',
            ...
            'TUH3', 'TUR3', 'TUUH', 'TV9I', 'TVD4', 'TVFQ', 'TVH3', 'TVXJ', 'TW3F', 'TWBI', 'TWKA', 'TWTU', 'TX0D', 'TX2L', 'TX5T', 'TX7H', 'TXML', 'TXUE', 'TXYE', 'TY2W', 'TYA0', 'TYLW', 'TYPH', 'TYRY', 'TYVB', 'TYXT', 'TYZS', 'TZ8X', 'TZER', 'TZKV', 'TZNB', 'TZOH', 'TZR7', 'TZZI', 'FBVM', 'T3N8', 'FSW1']
